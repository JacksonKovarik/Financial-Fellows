...
export default function Years ({navigation}) {
    ...
    // Information needed for the linechart
    ...
    <ImageBackground source={background} style={{flex:1, justifyContent: 'center'}}>
        <View style = {{flex: 1, alignItems: 'center',}}>
                ...
                > 
                    ...
                    <View style={{alignItems: 'center', justifyContent: 'center',flex: 1, paddingRight: 70}}>
            ...
            <View style = {[styles.profit, {top: 310}]}>
                <Text style = {styles.income_text}>Total Profit:</Text><Text style = {styles.income_text}>{'\t $0.00'}</Text>
